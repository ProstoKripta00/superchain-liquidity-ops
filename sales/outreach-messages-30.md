# Outreach Messages - 30 Superchain DEX Leads
...
DM:
Hi Uniswap team - I was reviewing public Base, Optimism, Unichain, and Zora DEX data. The Superchain footprint is large enough that a consolidated evidence view could be useful for liquidity and ecosystem decisions. Could I send a sample 7-day Liquidity Impact Report from Superchain Liquidity Ops?

Email:
Subject: Uniswap Superchain liquidity evidence report

Hi Uniswap team,

I reviewed public Base, Optimism, Unichain, and Zora DEX data and saw a clear need for one consolidated evidence view across the Superchain footprint.
...
I reviewed public Base DEX data and noticed a sharp 7d volume drop. That kind of move is worth explaining before incentives, BD follow-up, or internal liquidity decisions.
...
I reviewed public Base, Optimism, and Unichain DEX data and saw a sharp 7d volume drop that could use a clean source-backed explanation.
...
I reviewed public Base DEX data and noticed a sharp 7d volume drop. This is exactly the type of case where a short evidence pack is useful before incentives or BD action.
...
DM:
Hi Velodrome team - I was reviewing public Optimism, Mode, and Unichain DEX data. The multi-chain Superchain footprint looks like a good fit for one consolidated monitoring report. Could I send a Superchain Market Monitoring sample scope?

Email:
Subject: Velodrome Superchain market monitoring

Hi Velodrome team,

I reviewed public Optimism, Mode, and Unichain DEX data and saw a strong use case for one consolidated evidence view.
...
I reviewed public Base DEX data and saw visible volume where fee attribution could use a clean evidence pack.
...
Note: verify the current official contact before sending.
...
I reviewed public Base DEX data and noticed a sharp 7d volume drop.
...
I reviewed public Base DEX data and saw recent volume weakness that could use a clean source-backed report.
...
Note: manual contact discovery is required before sending.
...
I reviewed public Base DEX data and saw recent volume weakness that could use a source-backed explanation.
...
DM:
Hi Balancer team - I was reviewing public Base, Optimism, and Mode DEX data. The multi-chain Superchain footprint looks like a good fit for one consolidated monitoring report. Could I send a sample scope?

Email:
Subject: Balancer Superchain market monitoring

Hi Balancer team,

I reviewed public Base, Optimism, and Mode DEX data and saw a clear use case for one consolidated Superchain evidence view.
...
I reviewed public Base and Optimism DEX data and saw recent volume weakness.
...
I reviewed public Base DEX data and saw recent volume weakness.
...
DM:
Hi DackieSwap team - I was reviewing public Base, Optimism, and Mode DEX data. The multi-chain footprint could use one consolidated Superchain evidence view. Could I send a monitoring sample scope?

Email:
Subject: DackieSwap Superchain market monitoring

Hi DackieSwap team,

I reviewed public Base, Optimism, and Mode DEX data and saw a useful angle for one consolidated Superchain evidence view.
...
I reviewed public Unichain DEX data and noticed a sharp 7d volume drop.
