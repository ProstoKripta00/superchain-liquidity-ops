...
- Networks: OP Mainnet, Base
- Metrics: TVL, DEX volume, fees, market health, source audit
- Delivery format: Markdown report + CSV export
- Timeline: 3-5 days
...
Start with a diagnostic sprint before committing to recurring monitoring. The first paid deliverable should include a source-linked report, matched market CSV, source limitations, and three concrete next actions for the protocol team.
