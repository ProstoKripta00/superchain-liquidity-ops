...
-- Use this when moving from local demo mode to Supabase production mode.
...
-- Production policy outline:
-- client: can read/write own organization requests and visible report files
-- operator/admin: can manage all organizations, requests, reports and files
-- storage: private bucket, signed URLs for client-visible files`;
